                            ...
                            <div class="row align-items-center justify-content-center">
                                <!-- <div class="col-4">
                                    <div class="form-check">
                                        <label class="form-check-label" for="packs"> Qty: </label>
                                        <input type="number" id="newStock-addup" name="newStock-addup"
                                            onchange="addNewValues()" class="form-control" required>
